...
def organise_per_clusters(msa, estructuras, labels, rmsd_matrix, output_base="rna_clusters"):
    ...
    rep_dir = os.path.join(output_base, "representatives")
    ...
    for group, indices in grups.items():
        grupo_dir = os.path.join(output_base, f"cluster_{group}")
        ...
        rep_file = os.path.join(rep_dir, f"rep_cluster_{group}.fold")
