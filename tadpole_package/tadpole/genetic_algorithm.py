...
from tadpole.rna_structures import get_pairing_dict, constrained_mfe, get_pair_table
...
from tadpole.search import count_rna1_rna3_pairings, check_rna1_structure_preserved

import tadpole.search # Import the whole module to access its functions
...
def fitness(individual, rna1_orig, rna3_orig, struct1_orig, constraint_orig, watched_positions_orig,
    ...
    changes_rna1_in_constrained = tadpole.search.check_rna1_structure_preserved(rna1_mutated, linker, rna3_orig, struct_constr, struct1_orig)
...
def run_genetic_algorithm_search(rna1, rna3, struct1, constraint,
    ...
    log_func(f"\n🚀 Starting Genetic Algorithm for linker_length = {linker_length_ga}...")
    ...
    if valid_solutions_from_ga:
        ...
        log_func(f"❌ No valid linkers found by Genetic Algorithm for linker_length = {linker_length_ga}.")
